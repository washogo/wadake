  ...
  return (
    <div className="min-h-screen bg-gray-50">
                  ...
                  <div key={income.id} className="p-6 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="text-lg font-medium text-gray-900">{income.category.name}</h3>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="text-right">
                          <p className="text-xl font-bold text-green-600">+¥{formatAmount(income.amount)}</p>
                        </div>
      ...
      <DeleteConfirmDialog
        ...
        title="収入を削除"
        message={`「${deletingIncome?.category.name} - ¥${
          deletingIncome ? formatAmount(deletingIncome.amount) : ''
        }」を削除しますか？`}
