  ...
  return (
    <div className="min-h-screen bg-gray-50">
                  ...
                  <div key={expense.id} className="p-6 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="text-lg font-medium text-gray-900">{expense.category.name}</h3>
      ...
      <DeleteConfirmDialog
        ...
        title="支出を削除"
        message={`「${deletingExpense?.category.name} - ¥${
          deletingExpense ? formatAmount(deletingExpense.amount) : ''
        }」を削除しますか？`}
